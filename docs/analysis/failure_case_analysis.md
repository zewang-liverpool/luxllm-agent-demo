...
main\_objective: explore\_stale\_tiles
...
main\_objective: explore\_relic\_candidates
...
decision\_source: rule\_only

fallback\_used: true

fallback\_reason: force\_rule\_only

llm\_mode: force\_rule\_only
...
decision\_source: rule\_fallback
...
has\_exact\_llm\_decision: false

has\_recent\_llm\_decision: true

cached\_llm\_turn: true

llm\_step\_used: previous step

overlay\_summary: Using most recent LLM plan from step X
...
replay.experiment\_tag == trace.experiment\_tag
