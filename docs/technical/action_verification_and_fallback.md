...
| `rule\_fallback` | A rule-based fallback replaced or repaired a decision |
...
LLM-related decision events = llm\_fresh + cached\_llm
...
Fallback-related decision events = fallback + rule\_fallback
